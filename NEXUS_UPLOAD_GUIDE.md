...
**方法一：分开打包（推荐）**
- 创建 `Chinese Spring Festival v1.0.2.zip`，包含两个文件夹：
  ```
  Chinese Spring Festival v1.0.2.zip
  ├── StardewValley-SpringFestival/
  └── SpringFestivalHelper/
  ```
...
4. 将压缩包重命名为 `Chinese Spring Festival v1.0.2.zip`
...
1. 点击 **Files** 标签
2. 点击 **Add File**
3. 上传你创建的 `Chinese Spring Festival v1.0.2.zip`
4. 填写版本信息：
   - **File name**: `Chinese Spring Festival v1.0.2`
   - **File version**: `1.0.2`
